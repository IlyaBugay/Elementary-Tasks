...
namespace Task1
{
    class UserInterface
    {
        ...
        {
            point.Row = Validator.ValidateInputIntegerValue($"{Messages.INPUT_WIDTH_MESSAGE}");
            point.Column = Validator.ValidateInputIntegerValue($"{Messages.INPUT_HEIGHT_MESSAGE}");
        }
